...
addProperty(PageLabel, {
	...
	Font = 'SourceSansBold',
	Text = "  A K A S E N S E I・Online Search",
	TextSize = 12,
...
addSettingsHeader("Made by IDK・A K A S E N S E I"..version)
...
function showPage(page_to_show)
    ...
    if page_to_show == nil then
        PageLabel.Text = ("  A K A S E N S E I" .. version)
        return
    end
	...
	if page_to_show == "OnlineSearchPage" then
		PageLabel.Text = "  A K A S E N S E I・Online Search"
	elseif page_to_show == "FavoritesPage" then
		PageLabel.Text = "  A K A S E N S E I・Favorites"
	elseif page_to_show == "SettingsPage" then
		PageLabel.Text = "  A K A S E N S E I・Settings"
	end
